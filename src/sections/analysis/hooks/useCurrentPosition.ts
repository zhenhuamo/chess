...
import { CurrentPosition, PositionEval } from "@/src/types/eval";
  ...
  useEffect(() => {
        ...
        position.lastEval =
          evalIndex > 0
            ? {
                ...
                lines: gameEval.positions[evalIndex - 1].lines.slice(0, multiPv),
              }
            : undefined;
      }
    }
    ...
    if (
      ...
      const getPositionEval = async () => {
        ...
        const rawPositionEval = await getFenEngineEval(board.fen(), setPartialEval);
